...
const AuditorDashboard = () => {
  ...
  const loadAccountTransactions = async (accountNum) => {
    ...
    try {
      const response =
        await apiService.getTransactionsByAccountNumber(accountNum);
      if (response.data) {
          ...
          <div className="overview-cards">
            ...
            <div className="stat-card">
              ...
              <p className="stat-number">
                {systemTotals?.totalTransactions || 0}
              </p>
            </div>
          </div>
            ...
            <div className="search-form">
              ...
              <div className="form-group">
                <input
                  ...
                  className="form-input"
                />
                <button className="btn btn-primary" onClick={searchTransaction}>
                  Search Transaction
                </button>
              </div>
            </div>
          ...
          <div className="user-details">
            ...
            <div className="detail-card">
              ...
              <div className="detail-row">
                ...
                <span
                  className={`value ${selectedUser.active ? "active" : "inactive"}`}
                >
              ...
              <div key={account.id} className="account-card">
                ...
                <div className="account-details">
                  ...
                  <button
                    ...
                    onClick={() =>
                      loadAccountTransactions(account.accountNumber)
                    }
                  >
                    View Transactions
                  </button>
          ...
          <div className="account-details">
            ...
            <div className="detail-card">
              ...
              <div className="detail-row">
                <span className="label">Status:</span>
                <span
                  className={`value ${selectedAccount?.status?.toLowerCase()}`}
                >
            ...
            <button
              className="btn btn-primary"
              onClick={() =>
                loadAccountTransactions(selectedAccount.accountNumber)
              }
            >
          ...
          <div className="transaction-details">
            ...
            <div className="detail-card">
              ...
              <div className="detail-row">
                <span className="label">Status:</span>
                <span
                  className={`value ${selectedTransaction?.status?.toLowerCase()}`}
                >
